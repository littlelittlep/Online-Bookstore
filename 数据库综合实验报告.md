...
在系统实现中，用户功能函数主要包括注册新用户、用户登录、修改信息、查阅书籍、购买书籍等操作，其对应的部分函数代码实现如下所示：

##### 3.1.1用户注册

![1675045306902](assets/1675045306902.png)
...
用户查阅书籍操作包括查阅全部书籍、查询特定种类的书籍以及某本书的信息；

![1675045623571](assets/1675045623571.png)

##### 3.1.4加入购物车

通过此函数用户可以将心仪书籍加入购物车，同时为用户计算折扣后的价格供其参考，具体代码实现如下图所示：

![1675048456956](assets/1675048456956.png)

##### 3.1.5查看购物车

![1675046767220](assets/1675046767220.png)

#### 3.2管理员操作

##### 3.2.1添加书籍

![1675046132351](assets/1675046132351.png)
...
![1675046380347](assets/1675046380347.png)

##### 3.2.4删除订单

当用户提交取消订单的申请后，由管理员审核后方可删除订单，完成退款；具体代码实现如下图所示：

![1675048679638](assets/1675048679638.png)
